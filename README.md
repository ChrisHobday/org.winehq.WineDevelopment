...
## Installing
- Download WineDevelopment9.14.flatpak, WineDevelopment.mono9.2.0.flatpak, and WineDevelopment.gecko2.47.4.flatpak from releases
- Install WineDevelopment9.14.flatpak, WineDevelopment.mono9.2.0.flatpak, and WineDevelopment.gecko2.47.4.flatpak (sudo needed for installing single use Flatpak bundle)
```console
sudo flatpak install WineDevelopment9.14.flatpak
```
```console
...
```console
flatpak build-bundle repo WineDevelopment9.14.flatpak org.winehq.WineDevelopment stable-23.08
```
```console
